...
func Test_gitService_GrepText(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []string{"findings.txt:3:123@private-key", "findings.txt:6:tag: private-key", "findings.txt:8:most-private-key", "findings.txt:10:private-key@12344", "private-key.txt:3:123@public-key", "private-key.txt:6:tag: public-key", "private-key.txt:8:most-public-key", "private-key.txt:10:public-key@12344"},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
